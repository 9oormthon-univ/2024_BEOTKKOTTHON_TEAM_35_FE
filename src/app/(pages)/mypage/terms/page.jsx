...
export default function Terms() {
    return(
        <div class="flex flex-col items-center">
            <div class="w-full max-w-[500px] pb-14 px-4">
                ...
                <div class="flex justify-between h-9 items-center">                    
                    ...
                    <div class="flex justify-between items-center h-[36px]">
                        <p class="font-medium">이용약관</p>
                    </div>

                    <div class="w-[24px]"></div>
                </div>

                <p className="mt-[29px] text-[12px] w-full whitespace-pre-line">{`제 1 장 총칙

제 1 조 (목적)
본 약관은 구름톤 유니브 주최 벚꽃톤이 운영하는 돈버니(이하 돈버니")에서 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
