...
const LockStageBox = ({ num }) => {
  return (
    <div className="cursor-pointer relative flex flex-col justify-center items-center w-full h-[120px] border border-[#C9CDD2] bg-[#E8EBED] rounded-xl shadow-[0_1px_20px_0px_rgba(0,0,0,0.05)]">
