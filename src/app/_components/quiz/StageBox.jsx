...
const StageBox = ({ num }) => {
  return (
    <div className="relative flex flex-col justify-center items-center w-full h-[120px] border border-[#4E60FF] bg-[#ECF3FF] rounded-xl shadow-[0_1px_20px_0px_rgba(0,0,0,0.05)]">
